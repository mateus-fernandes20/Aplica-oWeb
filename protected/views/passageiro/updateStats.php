...
<h1>Update Stats for <?php echo CHtml::encode($passageiro->email); ?></h1>
...
$form = $this->beginWidget('CActiveForm', array(
    ...
    <div class="form">
        <div class="row">
            <b><?php echo CHtml::encode($passageiro->getAttributeLabel('stats')); ?>:</b>
            <?php echo $form->dropDownList($passageiro, 'stats', array(
                'A' => 'Active',
                'I' => 'Inactive',
            ), array('prompt' => 'Select Status')); ?>
            <?php echo $form->error($passageiro, 'stats'); ?>
        </div>
